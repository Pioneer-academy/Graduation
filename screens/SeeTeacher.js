...
export default function SeeTeacher() {
  ...
  const handleFetchUser = () => {
    axios
      ...
      .then((response) => {
        const fetchedTeachers = response.data.filter(
          (user) => user.position === 'teacher' || user.position === 'Teacher'
        );
        ...
        <ScrollView style={{ backgroundColor: 'white', minHeight: Dimensions.get('window').height }}>
          {teachers.map((teacher) => (
            ...
            >
              ...
              <Image source={require('../assets/images/prof.png')} style={{ width: 40, height: 40, left: 270, top: -30 }} />
